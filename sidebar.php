	    ...
	    <div class="row">
	        ...
	        <div class="col-10">
	            ...
	            <a data-toggle="collapse" href="#" data-target=".collapse" role="button">
	                <h3 class="mt-2 mb-2 text-white">Printink Caisse</h3>
	            </a>
	        </div>
	    </div>
	</div>
	    ...
	    <div class="row vh-100 flex-nowrap">
	        <div class="col-sm-2 collapse show sidebar bg-dark px-0 position-fixed">
	            <ul class="nav flex-column flex-nowrap pt-2 vh-100" id="sidebar">
	            	...
	            	<li class="nav-item">
	                    <a class="nav-link <?php echo $dashboard_active; ?>" href="dashboard.php"><span class="ml-2 d-none d-sm-inline"><i class="fas fa-tachometer-alt"></i> Tableau de Bord</span></a>
	                </li>
	            	...
	            	?>
	            	<li class="nav-item">
	                    <a class="nav-link <?php echo $user_active; ?>" href="user.php"><span class="ml-2 d-none d-sm-inline"><i class="fas fa-users"></i> Employé</span></a>
	                </li>
	                <li class="nav-item">
	                    <a class="nav-link <?php echo $department_active; ?>" href="department.php"><span class="ml-2 d-none d-sm-inline"><i class="far fa-building"></i> Liste des articles</span></a>
	                </li>
	            	<?php
	            	}
