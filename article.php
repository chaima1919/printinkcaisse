    	...
    	<form method="post" id="deparment_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">Ajout Article</h4>
        		...
        		<div class="modal-body">
        			<span id="form_message"></span>
		          	<div class="form-group">
		          		<div class="row">
			            	<label class="col-md-4 text-right">Article</label>
			            	<div class="col-md-6">
			            		<input type="text" name="article_name" id="article_name" class="form-control" required data-parsley-pattern="/^[a-zA-Z\s]+$/" data-parsley-trigger="keyup" />
			            	</div>
			            </div>
		          	</div>
		          	<div class="form-group">
...
$(document).ready(function(){
	...
	$('#add_department').click(function(){
    	...
    	$('#modal_title').text('Ajout Article');
