    	...
    	<form method="post" id="user_form" enctype="multipart/form-data">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">Ajout Employé</h4>
          			<button type="button" class="close" data-dismiss="modal">&times;</button>
        		</div>
        		<div class="modal-body">
		          	<div class="form-group">
		          		<div class="row">
			            	<label class="col-md-4 text-right">Nom et Prénom  <span class="text-danger">*</span></label>
			            	<div class="col-md-8">
		          	...
		          	<div class="form-group">
		          		<div class="row">
			            	<label class="col-md-4 text-right">Num Tel  <span class="text-danger">*</span></label>
			            	<div class="col-md-8">
		          	...
		          	<div class="form-group">
		          		<div class="row">
			            	<label class="col-md-4 text-right">Pseudo<span class="text-danger">*</span></label>
			            	<div class="col-md-8">
			            		<input type="text" name="admin_pseudo" id="admin_pseudo" class="form-control" required data-parsley-maxlength="150" data-parsley-trigger="keyup" />
			            	</div>
			            </div>
		          	</div>
...
$(document).ready(function(){
	...
	$('#add_user').click(function(){		
    	...
    	$('#modal_title').text('Ajout Employé');
    	$('#action').val('Add');
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#admin_pseudo').val(data.admin_pseudo);
	        	...
	        	$('#modal_title').text('Modifier Employé');
	        	$('#action').val('Edit');
